...
parser.add_argument('image_file', help = 'the image file name. Image should be in the folder.')
parser.add_argument('mod', help = 'Possible argument: [blur / br, block / bk, noise / ne, saliency / sy] ')

args = parser.parse_args()
logging.warning("Ignore argument error if not using command line")
command_line(args.image_file,args.mod)  
